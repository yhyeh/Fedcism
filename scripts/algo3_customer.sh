    ...
    for VI in 3; do
      ...
      # shard 10 fed
        python3 main_fed.py --dataset ${DATA} --model cnn --num_classes ${NCLS} --epochs ${EP} --lr ${LR} \
          ...
          --cls_imb --vol_imb ${VI} --clsimb_type customize \
          --data_distr cus_dict_users_vi${VI}_r${RUN}.pkl
      ...
      for ALGO in 3 0; do
        ...
        python3 main_slct_algo3.py --dataset ${DATA} --model cnn --num_classes ${NCLS} --epochs ${EP} --lr ${LR} \
          ...
          --cls_imb --vol_imb ${VI} --data_distr cus_dict_users_vi${VI}_r${RUN}.pkl \
          --epsilon ${E} --clsimb_type customize \
          --gpu 2
