...
for RUN in 2_c0.05; do
  ...
  python3 main_slct.py --dataset cifar10 --model cnn --num_classes 10 --epochs ${EP} --lr ${LR} \
    --num_users 100 --shard_per_user 10 --frac 0.1 --local_ep ${LE} --local_bs 50 \
  ...
  python3 main_fed.py --dataset cifar10 --model cnn --num_classes 10 --epochs ${EP} --lr ${LR} \
    --num_users 100 --shard_per_user 10 --frac 0.05 --local_ep ${LE} --local_bs 50 \
    --results_save cossim${RUN}
  ...
  # shard 2 fed w/ sel
  python3 main_slct.py --dataset cifar10 --model cnn --num_classes 10 --epochs ${EP} --lr ${LR} \
    --num_users 100 --shard_per_user 2 --frac 0.1 --local_ep ${LE} --local_bs 50 \
    --results_save cossim${RUN} --myalgo ${ALGO} --gamma 0.8 --wndw_size 20
  '
  # shard 2 fed
  python3 main_fed.py --dataset cifar10 --model cnn --num_classes 10 --epochs ${EP} --lr ${LR} \
    --num_users 100 --shard_per_user 2 --frac 0.05 --local_ep ${LE} --local_bs 50 \
    --results_save cossim${RUN}
