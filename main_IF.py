...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        '''
            ...
            # find similar client
            #cossim_factor = 1+args.gamma*(cosine_similarity(distr_users[idx], distr_glob_fraction))
            cossim_factor = 1
        ...
        cossim_glob_uni[iter] = cosine_similarity(distr_glob_fraction, distr_uni)

        #print('global distribution: ', distr_glob_fraction)
